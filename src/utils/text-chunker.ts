...
export function chunkText(text: string, options: ChunkingOptions = {}): TextChunk[] {
  const { maxTokens = 500, overlapTokens = 50, tokenEstimator = defaultTokenEstimator } = options;
 ...
 */
export function chunkTextSimple(text: string, maxTokens: number = 500): string[] {
