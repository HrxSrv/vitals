...
export const BIOMARKER_ALIASES: Record<string, string> = {
  ...
  // RBC variants — preserve method specificity
  rbc: 'rbc',
  'red blood cells': 'rbc',
  'red blood cell count': 'rbc',
  erythrocytes: 'rbc',
  'rbc electrical impedance': 'rbc_electrical_impedance',
  'rbc(electrical impedance)': 'rbc_electrical_impedance',
  'rbc (electrical impedance)': 'rbc_electrical_impedance',
  'rbc impedance': 'rbc_electrical_impedance',
  'rbc laser': 'rbc_laser',
  'rbc(laser)': 'rbc_laser',
  'rbc (laser)': 'rbc_laser',
  platelet: 'platelets',
  ...
  'mcv rbc histogram': 'mcv_rbc_histogram',
  'mcv(rbc histogram)': 'mcv_rbc_histogram',
  'mcv (rbc histogram)': 'mcv_rbc_histogram',
  mch: 'mch',
